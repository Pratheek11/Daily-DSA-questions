class SatisfyEquationEquality {
    ...
    // for dsu tutorial, please check out
    ...
    public boolean equationsPossible(String[] equations) {
        ...
        for (String e : equations) {
            ...
            if (e.charAt(1) == '=') {
                ...
                // how? we use `find` function to find out the parent group of the target
                // character index
                // then update parent. a & b would be in group 1 (i.e. a merged into the group
                // where b belongs to)
                // or you can also do `parent[find(e.charAt(3)- 'a')] = find(e.charAt(0) -
                // 'a');` (i.e. b merged into the group where a belongs to)
